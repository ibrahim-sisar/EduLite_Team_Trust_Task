...
import {closeAddBook} from"../store/slices/modalsSlice.ts"
import type {RootState} from "../store/store.ts";
import {AddBook} from "../store/slices/bookSlice.ts";
...
const BookForm = () => {
    ...
    const AddBookModal=useSelector((state:RootState)=>{return state.modals.AddBook})
                ...
                <div className="relative bg-gray-700 rounded-lg shadow-sm ">
                    <div
                        ...
                        <button type="button"
                                ...
                                onClick={()=>{dispatch(closeAddBook());reset()}}
                        >
